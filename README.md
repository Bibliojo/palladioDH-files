...
network graph walkthrough
Palladio treats the first table as the core dataset, and every additional table you add is “extended data.”


Main Table tabular data e.g., a csv file
   +
